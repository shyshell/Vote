  ...
  <div class="vote">
    ...
    <div class="profile">
      <div class="details">
        ...
        <div class="info">2 days to the end of voting</div>
      </div>
      <div class="dp">
        <img
          @click="openMenu"
    ...
    <hr class="line" />
    <div v-for="(position, i) in positions" :key="i" class="vote-card">
      <div class="prof-icon">
      ...
      <div class="marker">
        <div class="label">
          ...
          <div class="bubble-marker">vote</div>
        </div>
...
export default {
  ...
  methods: {
    openMenu(){
      this.status = 'dropdown-menu show'
      this.$forceUpdate()
    }
  }
};
...
<style lang="sass" scoped>
  ...
  @import '../../styles/mobile/vote.scss';
</style>